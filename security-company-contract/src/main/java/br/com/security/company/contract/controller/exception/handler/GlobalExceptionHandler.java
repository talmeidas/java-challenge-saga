package br.com.security.company.contract.controller.exception.handler;

import br.com.security.company.contract.dto.*;
...
public class GlobalExceptionHandler {
    ...
    public HttpResponseStatusDTO handleHttpMessageNotReadableException(final HttpMessageNotReadableException exception, final Locale locale) {
    ...
    public HttpResponseStatusDTO handleConstraintViolationException(final ConstraintViolationException exception, final Locale locale) {
    ...
    public HttpResponseStatusDTO handleIllegalArgumentException(final IllegalArgumentException exception, final Locale locale) {
        final String message = messageSource.getMessage(exception.getMessage(), null, locale);
        return buildHttpResponseStatus(HttpStatus.BAD_REQUEST, message, webRequest.getContextPath());
    }
    ...
    public HttpResponseStatusDTO handleDataIntegrityViolationException(final DataIntegrityViolationException exception, final Locale locale) {
    ...
    public HttpResponseStatusDTO handleEntityNotFoundException(final EntityNotFoundException exception, final Locale locale) {
        final String message = messageSource.getMessage(exception.getMessage(), null, locale);
    ...
    public HttpResponseStatusDTO handleAccessDeniedException(final AccessDeniedException exception, final Locale locale) {
